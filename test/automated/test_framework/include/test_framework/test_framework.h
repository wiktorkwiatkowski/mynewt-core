...
#define MTEST_INIT(suite_name) \
    void MTEST_INIT_##suite_name(void)

#define MTEST_CLEANUP(suite_name) \
    void MTEST_CLEANUP_##suite_name(void)
...
#define MTEST_CASE_DECL(case_name) \
    void case_name()
...
#define MTEST_SUITE_DECL(suite_name) \
    void suite_name()

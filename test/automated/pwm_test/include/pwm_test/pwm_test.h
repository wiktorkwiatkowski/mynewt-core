...
#define TIMER1_FREQ_HZ    MYNEWT_VAL(OS_CPUTIME_FREQ)
#define SAMPLE_FREQ_HZ    1000
#define PWM_FREQ_HZ       200

#define TIMER_TICKS (TIMER1_FREQ_HZ / SAMPLE_FREQ_HZ)
#define MEASURE_TIME_S    1
#define WINDOW_SIZE (SAMPLE_FREQ_HZ * MEASURE_TIME_S)

#if MYNEWT_VAL(BSP_nucleo_f767zi) || \
MYNEWT_VAL(BSP_nucleo_h753zi)     || \
MYNEWT_VAL(BSP_nucleo_f411re)     || \
MYNEWT_VAL(BSP_nucleo_g491re)     || \
